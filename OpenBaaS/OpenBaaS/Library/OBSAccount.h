 ...
 *
 * @warning If the application requires an e-mail confirmation, a session will
 *          not be opened. In such a case, the handler will run with the argument
 *          values `YES`, `nil` and `nil`, in the defined order.
 *
