...
{
    if (!email || [email isEqualToString:[NSString string]]) {
        return NO;
    }

    NSPredicate *regExPredicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", _kEmailRegEx];
