...
static NSString *const _appid = @"com.infosistema.openbaas.libcocoa.apps.SimpleImageGallery-iOS.appid";
static NSString *const _appKey = @"com.infosistema.openbaas.libcocoa.apps.SimpleImageGallery-iOS.appkey";
