...
static NSString *const _appid = @"com.infosistema.openbaas.libcocoa.apps.Integration.appid";
static NSString *const _appKey = @"com.infosistema.openbaas.libcocoa.apps.Integration.appkey";
