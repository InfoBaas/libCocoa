...
#warning TODO present a wait screen
    ...
    [account signInWithEmail:self.emailTextField.text password:self.passwordTextField.text completionHandler:^(OBSAccount *account, OBSError *error, OBSSession *session) {
