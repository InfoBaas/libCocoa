...
static NSString *const _appid = @"com.infosistema.openbaas.libcocoa.apps.SimpleDataSearch-iOS.appid";
static NSString *const _appKey = @"com.infosistema.openbaas.libcocoa.apps.SimpleDataSearch-iOS.appkey";
